...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/map2.jpg);height: 400px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      ...
                      <?php
                          ...
                          $passResult = mysqli_query($conn, $passSql) or die("Connection Failed");
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact2.jpeg)" > 
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/SaileePhal" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
