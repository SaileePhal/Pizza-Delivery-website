...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($numExistRows > 0){
      ...
      if(($password == $cpassword)){
          ...
          if ($result){
              $showAlert = true;
              header("Location: /OnlinePizzaDeliverySystem/index.php?signupsuccess=true");
          }
      }
      else{
          $showError = "Passwords do not match";
          header("Location: /OnlinePizzaDeliverySystem/index.php?signupsuccess=false&error=$showError");
      }
    }
}
